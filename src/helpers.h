...
public:
  ...
  inline vector<double> getFrenet(double x, double y, double theta)
  {
    ...
    {
      frenet_s += distance(m_map_waypoints_x[i], m_map_waypoints_y[i], m_map_waypoints_y[i + 1], m_map_waypoints_y[i + 1]);
    }
  ...
  inline vector<double> getXY(double s, double d)
  {
    ...
    double heading = atan2((m_map_waypoints_y[wp2] - m_map_waypoints_y[prev_wp]),
                           (m_map_waypoints_x[wp2] - m_map_waypoints_x[prev_wp]));
